...
rctarget_align.stack          = ['FAFB_v12_dmesh_cpp_align_test_'  num2str(nfirst) '_' num2str(nlast)];
...
opts.min_tiles = 20000; % minimum number of tiles that constitute a cluster to be solved. Below this, no modification happens
...
[L_all, tIds, PM, pm_mx, sectionId_load, z_load]  = ...
                   load_point_matches(nfirst, nlast, rcsource,...
                   pm, opts.nbrs, opts.min_points, opts.xs_weight);
disp('reducing to connectected component');
[L_vec, ntiles] = reduce_to_connected_components(L_all, opts.min_tiles);
L = L_vec(1);
%%

fnpmjson = ...
['/nobackup/flyTEM/khairy/FAFB00v13/point_match_clusters/' ...
'example01_FAFB_' num2str(nfirst) '_' num2str(nlast) '_pm.json'];
disp('Generating json file ...');
...
disp('Finished ingestion into Renderer collection');
kk_clock;
% 
% 
