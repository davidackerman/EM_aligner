...
opts.outlier_lambda = 1e0;  % large numbers result in fewer tiles excluded
opts.lambda = 10^(1);
...
optsp2 = opts;
optsp2.outlier_lambda = 1e0;
optsp2.degree = 2;
optsp2.lambda = 10^6;
optsp2.edge_lambda = 10^6;

optsp3 = opts;
optsp3.outlier_lambda = 1e0;
optsp3.degree = 3;
optsp3.lambda = 10^7;
optsp3.edge_lambda = 10^7;
...
failed_list = [];
count = 1;
parfor lix = 1:500 %[25 54] %1650:2000
