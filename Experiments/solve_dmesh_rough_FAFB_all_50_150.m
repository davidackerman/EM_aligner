...
precalc_path = '/nobackup/flyTEM/khairy/FAFB00v13/montage_scape_pms/solver_50.00_150.00';
precalc_ids = [ precalc_path '/ids.txt'];
precalc_matches = [precalc_path '/matches.txt'];
...
if run_now==0
    for ix = 1:numel(mLR.tiles)
        fn_im = sprintf('%s/layer_images/%.1f.png', precalc_path,zu(ix));
