...
% [3] also we should not even need L, but 
% [4] should be able to solve given point-matches only.
% [5] We need to express constraints in a more flexible way.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% solve for transformation coefficients using the set of montage and
%%% crosslayer point-matches (if provided).
%%%
%%%
%%% Input: L, P and options
%%% L is an array of Msection objects with the field "pm"
...
%%% P is a cell array of Msection pair information. Each entry contains M
