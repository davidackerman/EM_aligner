...
% detects jumps in a z stack through cross correlation within a Renderer box
% It c is not specified, the box is determined to be in the middle of the
