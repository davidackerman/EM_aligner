...
%%% deprecated?
[err,R, Tout, A, b, map_id, tIds, z_val, Diagnostics] = system_solve_rigid_approximation(sl.first_section, sl.last_section, sl.source_collection, sl.source_point_match_collection, sl.solver_options, sl.target_collection);
