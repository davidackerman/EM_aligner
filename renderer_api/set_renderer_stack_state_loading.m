function [resp, strcmd] = set_renderer_stack_state_loading(rc)
...
str13 = sprintf('%s/manage_stacks.sh --baseDataUrl %s --owner %s --project %s --action SET_STATE --stackState LOADING --stack %s', ...
