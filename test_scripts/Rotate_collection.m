...
x = 0;   % x coordinate of center of rotation
y = 0;   % y coordinate of center of rotation
deg = 90; % counter clockwise rotation of whole collection of tiles
