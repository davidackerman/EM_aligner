...
z = 4;
load([dir_test_data '/Msection_objects/Msection_region_FAFBv12_section_4_montage.mat']);
L_montage = L;
load([dir_test_data '/Msection_objects/Msection_region_FAFBv12_section_4_acquire.mat']);
L_acquire_full = L;
...
%% configure 
dir_example    = [dir_test_data '/example_02_' num2str(numel(L_montage.tiles)) '_z_' num2str(z)]; 
